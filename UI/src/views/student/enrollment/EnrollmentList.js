...
class StudentCourses extends React.Component {
    ...
    getCourses = () => {
        let callProps = {
            endpoint: "enrollments/getAllCoursesOnEnrollmentsByUserId/" + this.state.studentId,
            method: "GET",
            success: (response) => {
    ...
    onDetailClick = (courseId) => {
        Open(this.props.history, '/student/enrollments/detail', courseId);
    }
